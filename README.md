...
The fundamental architecture question: run ML on-device, send frames to a cloud API, or both? This affects cost, latency, accuracy, and whether baby images leave the machine.
