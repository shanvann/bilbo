...
When Warlord says "let's continue in tui/telegram/etc.", follow `HANDOFF.md` — save context to `context/<topic>.md` and give them the resume command. This is a core workflow, not optional.
